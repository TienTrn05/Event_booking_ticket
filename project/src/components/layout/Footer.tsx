...
const footerSections = [
  ...
  {
    title: 'Support',
    links: ['Help Center', 'Refund Policy', 'Terms of Service', 'Privacy Policy', 'Cookie Settings', 'Report an Issue'],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-extrabold tracking-tight">Eventix</span>
            </div>
            <p className="text-sm text-white/60 leading-relaxed max-w-xs mb-6">
              The modern ticketing platform for discovering and creating unforgettable live experiences.
            </p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="text-sm text-white/50 hover:text-white transition-colors">Cookies</a>
          </div>
        </div>
      </div>
    </footer>

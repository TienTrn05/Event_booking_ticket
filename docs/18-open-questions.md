...
| Q-016 | PARTIALLY RESOLVED | Bộ công cụ nhỏ, MySQL transaction/lock tường minh, pin khi code | Tên/phiên bản runtime/driver/validation/test/migration tools chọn lúc implementation |

...
Stack đã xác định: **React + TypeScript + Vite**. Thư viện cụ thể (routing, state, form, query) cần Q-016. Doc này đặc tả **phân tầng, ranh giới trách nhiệm và ràng buộc bắt buộc** độc lập với lựa chọn thư viện.

  ...
  return (
    <section id="spotlight" className={ui('home-chapter chapter-partners py-14 lg:py-20 bg-white')}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={ui('grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5')}>
          {officialEvents.map((event) => (
            ...
            >
              ...
              <div className={ui('p-5')}>
                <span
                  className={ui('text-xs font-semibold text-primary-600 uppercase tracking-wide')}
                >
                  {event.category}
                </span>
                <h3
                  className={ui(
                    'text-base font-bold text-ink-900 leading-snug mt-1.5 mb-3 line-clamp-2 group-hover:text-primary-700 transition-colors',
                  )}
                >
                  {event.title}
                </h3>
                ...
                <div className={ui('pt-3 border-t border-ink-100')}>
                  <span className={ui('text-xs text-ink-400 font-medium')}>Organizer</span>
                  <p className={ui('text-sm font-semibold text-ink-700 mt-0.5 truncate')}>
                    {event.organizer}
                  </p>
                </div>
              </div>
